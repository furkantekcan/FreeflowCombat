...
public class CombatScript : MonoBehaviour
{
    ...
    void AttackCheck()
    {
        ...
        if (enemyDetection.inputDirection.magnitude > .2f)
            lockedTarget = enemyDetection.currentTarget.GetComponent<EnemyController>();
        ...
        //AttackTarget
        Attack(lockedTarget, TargetDistance(enemyDetection.currentTarget.GetComponent<EnemyController>()));
    }
    ...
    void MoveTorwardsTarget(EnemyController target, float duration)
    {
    ...
    EnemyController ClosestCounterEnemy()
    {
        ...
        {
            EnemyController enemy = enemyManager.allEnemies[i].enemyController;
        ...
        return enemyManager.allEnemies[finalIndex].enemyController;
